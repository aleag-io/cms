...
export async function resetTestDb() {
  ...
  await testDb.$executeRawUnsafe(
    `TRUNCATE "AuditEntry", "MemberRegistration", "VolunteerAssignment", "CommunicationPreference", "MessageTemplate", "MessageRecipient", "Message", "FacilityBooking", "Facility", "EventAttendance", "Event", "OrganizationOfficer", "OrganizationMembership", "Organization", "ProgramSessionAttendance", "ProgramSession", "ProgramEnrollment", "Program", "ParishPermissionOverride", "MemberRelationship", "FamilyPastoralData", "MemberPastoralData", "MemberPrivateNote", "ParishOfficer", "MemberParish", "Member", "Family", "AppUser", "Parish", "Diocese" CASCADE`,
  );
